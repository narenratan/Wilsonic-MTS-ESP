...
Seed7::Seed7()
{
    ...
    setCanSort(true);
    setSort(true);
    setTuningName ("Seed 7");
}

Seed7::Seed7(Microtone_p A, Microtone_p B, Microtone_p C, Microtone_p D, Microtone_p E, Microtone_p F, Microtone_p G)
: Seed7()
{
    _A = A;
    _B = B;
...
Seed7::Seed7(vector<Microtone_p> master_set, vector<Microtone_p> common_tones)
: Seed7 ()
{
    // can't use "set" because it calls update...so duplicate code here
    jassert(master_set.size() == 7);
    _A = master_set[0];
    _B = master_set[1];
    _C = master_set[2];
    _D = master_set[3];
...
const vector<Microtone_p> Seed7::getMasterSet()
{
    return vector<Microtone_p> {_A, _B, _C, _D, _E, _F, _G};
}

void Seed7::set(vector<Microtone_p> master_set, vector<Microtone_p> common_tones)
{
...
void Seed7::setA(Microtone_p A)
{
    _A = A;
    update();
}

void Seed7::setA(float f)
{
...
const Microtone_p Seed7::getA()
{
    return _A;
}

void Seed7::setB(Microtone_p B)
{
    _B = B;
    update();
}

void Seed7::setB(float f)
{
...
const Microtone_p Seed7::getB()
{
    return _B;
}

void Seed7::setC(Microtone_p C)
{
    _C = C;
    update();
}

void Seed7::setC(float f)
{
...
const Microtone_p Seed7::getC()
{
    return _C;
}

void Seed7::setD(Microtone_p D)
{
    _D = D;
    update();
}

void Seed7::setD(float f)
{
...
const Microtone_p Seed7::getD()
{
    return _D;
}

void Seed7::setE(Microtone_p E)
{
    _E = E;
    update();
}

void Seed7::setE(float f)
{
...
const Microtone_p Seed7::getE()
{
    return _E;
}

void Seed7::setF(Microtone_p F)
{
    _F = F;
    update();
}

void Seed7::setF(float f)
{
...
const Microtone_p Seed7::getF()
{
    return _F;
}

void Seed7::setG(Microtone_p G)
{
    _G = G;
    update();
}

void Seed7::setG(float f)
{
...
const Microtone_p Seed7::getG()
{
    return _G;
}

void Seed7::setABCDEFG(Microtone_p A, Microtone_p B, Microtone_p C, Microtone_p D, Microtone_p E, Microtone_p F, Microtone_p G)
{
    _A = A;
    _B = B;
    _C = C;
...
const string Seed7::getTuningName()
{
...
const string Seed7::getTuningNameAsSymbols()
{
    auto basename = TuningImp::getTuningName();
    auto retVal = basename + "(" +
...
const string Seed7::getTuningNameAsUnderscores()
{
    auto basename = TuningImp::getTuningName();
...
const string Seed7::getTuningCreationCodegen(string parent_key, vector<string> s0_keys, vector<string> s1_keys)
{
    // common tones
    string ctstr = "";
    if(_commonTones.size() > 0)
    ...
    // master set
    retVal += "{_" + a + ",_" + b + ",_" + c + ",_" + d + ",_" + e + ",_" + f + ",_" + g + "}, ";
...
//    cps->set ({_A,_B,_C,_D,_E,_F,_G}, {});
const string Seed7::getTuningUpdateCodegen()
{
    string ctstr = "";
    ...
    string retVal = "cps->set ({_" + a + ",_" + b + ",_" + c + ",_" + d + ",_" + e + ",_" + f + ",_" + g + "}," + ctstr + ");";
